...
public class SequentialNotificationManager {
	...
	static WindowOpenListener listener;
	...
	public static void setListener(WindowOpenListener listener)
	{
		SequentialNotificationManager.listener=listener;
	}
