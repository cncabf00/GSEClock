...
public class NotificationBuilder {
	...
	private JWindow showNotificationEDT() {
		...
		glassPane.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent event) {
				...
				{
					fNotificationListener.doubleClicked();
				}
